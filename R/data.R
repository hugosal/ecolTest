...
#' \item{Sample.2}{The abundance of each species in the sample 2}
#' \item{Sample.3}{The abundance of each species in the sample 3}
#' \item{Sample.4}{The abundance of each species in the sample 4}
